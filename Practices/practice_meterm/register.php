                        ...
                        <div class="card-body">
                            <form action="process.php" method="post">
                                <div class="group-form">
                                    ...
                                    <input type="text" name="names" id="fname" placeholdeer="Username" class="form-control">
                                </div>
                                <div class="group-form">
                                ...
                                <div class="group-form">
                                    ...
                                    <input type="email" name="email" id="em" placeholdeer="Email" class="form-control">
                                </div>
                                ...
                                <div class="group-form mt-5">
                                  ...
                                  <button name="btn-register" class="btn btn-danger float-right">Back to login</button>
                                </div>
                            </form>
                        </div>
                </div>
