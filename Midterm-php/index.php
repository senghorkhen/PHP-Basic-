                    ...
                    <div class="card-body">
                        <form action="process.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="mail" class="form-control" placeholder="Email" require>
                            </div>
                            <!-- Select province -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-warning float-right" type="reset" name="btn-clear">Cancel Infomation</button>
                            </div>
                        </form>
                    </div>
                </div>
